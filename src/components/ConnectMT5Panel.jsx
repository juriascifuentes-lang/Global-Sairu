      ...
      {platform === "NINJATRADER" && (
        <>
          <div style={cardStyle}>
            ...
            <p style={{ margin: "0 0 18px", fontSize: "13px", color: "var(--text-muted)" }}>
              Archivo NinjaScript (.cs) — se importa directamente desde NinjaTrader sin necesidad de compilar manualmente.
            </p>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ marginTop: "20px", padding: "14px 16px", background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.18)", borderRadius: "12px", fontSize: "12px", color: "var(--text-muted)", display: "flex", gap: "10px", alignItems: "flex-start" }}>
              ...
              <span>
                <span style={{ color: "#10b981", fontWeight: "700" }}>Historial automático — </span>
                al activar el strategy sube todos los trades pasados. Los ya existentes en el journal no se duplican.
              </span>
            </div>
          </div>
        </>
